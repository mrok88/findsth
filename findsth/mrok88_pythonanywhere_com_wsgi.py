...
# web application at http://mrok88.pythonanywhere.com/
...
#import sys
#
#path = '/home/mrok88/path/to/my/app
...
#import sys
#
## assuming your django settings file is at '/home/mrok88/mysite/mysite/settings.py'
## and your manage.py is is at '/home/mrok88/mysite/manage.py'
#path = '/home/mrok88/mysite'
#if path not in sys.path:
#    sys.path.append(path)
#
...
#import sys
#
## The "/home/mrok88" below specifies your home
## directory -- the rest should be the directory you uploaded your Flask
## code to underneath the home directory.  So if you just ran
## "git clone git@github.com/myusername/myproject.git"
## ...or uploaded files to the directory "myproject", then you should
## specify "/home/mrok88/myproject"
#path = '/home/mrok88/path/to/flask_app_directory'
#if path not in sys.path:
#    sys.path.append(path)
#
